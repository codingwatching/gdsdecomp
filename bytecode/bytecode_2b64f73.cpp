...
int GDScriptDecomp_2b64f73::get_token_max() const {
	return TK_MAX;
}
String GDScriptDecomp_2b64f73::get_function_name(int p_func) const {
...
int GDScriptDecomp_2b64f73::get_function_count() const {
	return num_funcs;
}
Pair<int, int> GDScriptDecomp_2b64f73::get_function_arg_count(int p_func) const {
	if (p_func < 0 || p_func >= num_funcs) {
...
int GDScriptDecomp_2b64f73::get_function_index(const String &p_func) const {
...
GDScriptDecomp::GlobalToken GDScriptDecomp_2b64f73::get_global_token(int p_token) const {
...
int GDScriptDecomp_2b64f73::get_local_token_val(GDScriptDecomp::GlobalToken p_token) const {
	switch(p_token) {
